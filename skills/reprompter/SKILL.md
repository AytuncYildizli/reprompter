...
- **Grok delivery target requires headless-relay v2.0.0+.** headless-relay only isolates Grok
  fail-closed (non-git working dir) from v2.0.0 onward (**v2.0.5+ recommended: it also runs Grok
